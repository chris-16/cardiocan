...
import type { ExportData } from "@/lib/export-pdf";
...
export default function ExportCsvButton({ dogId, dogName }: ExportCsvButtonProps) {
  ...
  async function handleExport() {
    ...
    try {
      ...
      link.href = url;
      link.download = `CardioCAn_${safeName}_${dateStr}.csv`;
      link.click();
